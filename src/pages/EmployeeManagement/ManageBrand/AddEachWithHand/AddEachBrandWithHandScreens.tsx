...
interface AddBrandWithHandsFormProps {
    closeCard: () => void;
    addNewUser: (addedNewUser: User) => void
}

const AddEachBrandsWithHand: React.FC<AddBrandWithHandsFormProps> = ({ closeCard, addNewUser }) => {
...
export default AddEachBrandsWithHand;