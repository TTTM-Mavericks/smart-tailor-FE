...
interface EditOrderPopUpScreenFormProps {
    fid: {
        id: number;
        registrarId: string;
        name: string;
...
const EditOrderPopUpScreens: React.FC<EditOrderPopUpScreenFormProps> = ({ fid, editClose, updateUser }) => {
...
export default EditOrderPopUpScreens;
