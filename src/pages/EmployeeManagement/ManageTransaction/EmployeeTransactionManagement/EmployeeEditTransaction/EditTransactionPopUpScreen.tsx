...
interface EditTransactionPopUpScreenFormProps {
    fid: {
        id: number;
        registrarId: string;
        name: string;
...
const EditTransactionPopUpScreens: React.FC<EditTransactionPopUpScreenFormProps> = ({ fid, editClose, updateUser }) => {
...
export default EditTransactionPopUpScreens;
