                ...
                <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
                    ...
                    <div className="flex items-center">
                        ...
                        <a href="#">
                            ...
                            >
                                <span className="text-gray-900 font-semibold mr-2">Employee</span>
                                <img
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpQ38Y5BX3tg5s6s9IdpA_3qLavsqSLmrf_g&s"
