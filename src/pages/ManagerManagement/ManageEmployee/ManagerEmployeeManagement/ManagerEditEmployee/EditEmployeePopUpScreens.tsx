...
interface EditEmployeePopUpScreenFormProps {
    fid: {
...
const EditEmployeePopUpScreens: React.FC<EditEmployeePopUpScreenFormProps> = ({ fid, editClose, updateExpertTailoring }) => {
...
export default EditEmployeePopUpScreens;
