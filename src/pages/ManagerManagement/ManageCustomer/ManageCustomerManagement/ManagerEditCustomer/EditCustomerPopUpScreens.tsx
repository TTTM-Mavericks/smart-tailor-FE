...
interface EditCustomerPopUpScreenFormProps {
    fid: {
...
const EditCustomerPopUpScreens: React.FC<EditCustomerPopUpScreenFormProps> = ({ fid, editClose, updateExpertTailoring }) => {
