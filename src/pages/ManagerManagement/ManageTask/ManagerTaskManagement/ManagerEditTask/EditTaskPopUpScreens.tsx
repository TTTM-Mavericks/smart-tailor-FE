...
interface EditTaskPopUpScreenFormProps {
    fid: {
...
const EditTaskPopUpScreens: React.FC<EditTaskPopUpScreenFormProps> = ({ fid, editClose, updateExpertTailoring }) => {
...
export default EditTaskPopUpScreens;
