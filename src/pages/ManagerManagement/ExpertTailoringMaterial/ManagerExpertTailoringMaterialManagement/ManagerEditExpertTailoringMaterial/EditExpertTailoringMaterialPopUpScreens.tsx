...
interface EditExpertTailoringMaterialPopUpScreenFormProps {
    ...
    editClose: () => void;
    updateExpertTailoringMaterial: (updatedExpertTailoringMaterial: ExpertTailoringEdit) => void;
}

const EditExpertTailoringPopUpScreens: React.FC<EditExpertTailoringMaterialPopUpScreenFormProps> = ({ fid, editClose, updateExpertTailoringMaterial }) => {
    ...
    const _handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                updateExpertTailoringMaterial({ ...addNewExpertTailorings, expertTailoringID: fid.expertTailoringID })
                editClose()
            } else {
