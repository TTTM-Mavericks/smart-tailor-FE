...
const CardInformationDetailComponent = () => {
    ...
    useEffect(() => {
        fetchGrowthPercentage('/order' + functionEndpoints.chart.calculateOrderGrowthPercentageMonth, setOrderGrowthPercentage);
        fetchGrowthPercentage('/user' + functionEndpoints.chart.calculateUserGrowthPercentageMonth, setUserGrowthPercentage);
        fetchGrowthPercentage('/user' + functionEndpoints.chart.calculateCustomerGrowthPercentageMonth, setCustomerGrowthPercentage);
        fetchGrowthPercentage('/payment' + functionEndpoints.chart.calculatePaymentGrowthPercentageMonth, setPaymentGrowthPercentage);
    }, []);
    ...
    return (
        <div className="mt-12">
            <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
                <GrowthCard
                    title="Order Growth"
                    value={orderGrowthPercentage}
                    color="bg-gradient-to-tr from-blue-600 to-blue-400"
                    icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="w-6 h-6 text-white">
                ...
                <GrowthCard
                    ...
                    color="bg-gradient-to-tr from-pink-600 to-pink-400"
                    icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="w-6 h-6 text-white">
                ...
                <GrowthCard
                    ...
                    value={customerGrowthPercentage}
