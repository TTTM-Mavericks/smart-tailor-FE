...
const DashboardBarChartScreens = () => {
    const [menuOpen, setMenuOpen] = useState(false);
    const [activeMenu, setActiveMenu] = useState('bar_chart');
    ...
    return (
        <div className="flex">
            ...
            <div className="flex flex-col w-full">
                <Navbar toggleMenu={toggleMenu} menu="Bar Chart" popperOpen={popperOpen} togglePopper={togglePopper} />
...
export default DashboardBarChartScreens;
