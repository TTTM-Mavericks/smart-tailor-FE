...
import ManageSizes from '../AdminSizeManagement/AdminManagerScreen/ManageSizeScreens';

const DashboardAdminManageSizeScreen = () => {
...
export default DashboardAdminManageSizeScreen;
